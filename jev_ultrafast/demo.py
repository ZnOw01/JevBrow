...
PORT = int(os.environ.get("JEVBROW_DEMO_PORT", "8766"))
...
def response_state():
    ...
    return {**state, "text_model": os.environ.get("JEVBROW_MODEL", "gemini-3.8-flash-high"), "max_steps": MAX_STEPS}
...
def main():
    ...
    print(f"JevBrow local inspector: {ORIGIN}", flush=True)
    try:
